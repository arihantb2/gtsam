...
// ============================================================================
//  MEKF dynamics: world-frame strapdown mean propagation + finite-difference
//  state-transition Jacobian F.
//
//  Mean step (forward Euler of the nav-frame biased-INS kinematics):
//    R+ = R * Exp((omega - b_gyro) dt)
//    v+ = v + (R (accel - b_accel) + g) dt
//    p+ = p + v dt
//    biases unchanged.
//
//  F is computed by finite differences of the discrete map in local coords,
//  re-evaluated about the current estimate X each step (the MEKF trait under
//  study). Block order: [d_theta | d_v | d_p | d_b_gyro | d_b_accel].
// ============================================================================
