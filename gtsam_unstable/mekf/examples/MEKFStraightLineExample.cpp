/**
 * @file  MEKFStraightLineExample.cpp
 * @brief Baseline MEKF, IMU-only, accelerating oblique straight line.
 */
...
int main(int argc, char* argv[]) {
  ...
  try {
    const RunOptions opts =
        parseRunOptions(argc, argv, "mekf_straight_line.csv");
    ...
    std::cerr << "MEKFStraightLineExample failed: " << e.what() << '\n';
    return 2;
  }
  return 0;
}
